export const siteConfig = {
  ...
  aboutMe:
    "¡Hola, soy Glenda! Comunicadora Social con más de 5 años liderando y ejecutando estrategias de Social Media en el sector educativo y de eventos. Especializada en gestión de redes sociales, redacción creativa, colaboración en eventos de captación y fidelización, coordinación con el equipo comercial, diseño y audiovisual, Meta y TikTok Ads. He gestionado las cuentas de la Universidad Peruana Cayetano Heredia (UPCH) y la Universidad María Auxiliadora (UMA), generando comunidad digital y captación de leads orgánicos en pro a las metas comerciales. Siempre estoy en constante aprendizaje y comprometida en asumir nuevos retos para desarrollarme profesionalmente sumando a los objetivos de la empresa aportando en el buen clima laboral.",
